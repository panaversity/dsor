...
| A student who wants to build it | [`docs/baby_steps_tutorials/`](docs/baby_steps_tutorials/readme.md) — DSoR in 52 baby steps, built with Claude Code (step 00 is ready). The shorter map is [`docs/learn/learning-path.md`](docs/learn/learning-path.md) |
