// NEW IN STEP 03: the two schema files are copies. This test keeps them equal to the
// specification's own, whenever the specification is there to compare with.
