...
**v1.3 → v1.3.1 (this edition).** Editorial only. Added the [Start here](../docs/learn/start-here.md) chapter, a plain-language opening for every section, [Appendix D](../docs/learn/learning-path.md) (a staged build path), and [Appendix E](../docs/learn/questions.md) (questions and answers); removed paragraphs those openings made redundant. Every requirement sentence is unchanged, which the build verifies against v1.3's `requirements.json`.
